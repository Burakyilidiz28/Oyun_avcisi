...
def write_log(message):
    """İşlemleri bot_logs.txt dosyasına tarihle kaydeder."""
...
def get_sent_games():
    """sent_games.txt içindeki (ID:...) formatındaki ID'leri ayıklar."""
...
def add_to_sent_games(game_id, title, original_price_raw):
    """Dosyayı günceller, toplam kazancı hesaplar ve listeye ekler."""
    lines = []
    total_gain = 0.0
    games_list = []
